...
const AdvancedPaperTrading: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 rounded-3xl border border-slate-900 overflow-hidden text-slate-200 font-sans shadow-2xl">
...
export default AdvancedPaperTrading;
