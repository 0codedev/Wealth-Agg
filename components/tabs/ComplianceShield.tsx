                    ...
                    <div className="w-24 h-24 relative">
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                ...
                                <Tooltip formatter={(val: number) => formatCurrency(val)} contentStyle={{ backgroundColor: '#0f172a', borderColor: '#334155', color: '#f1f5f9', fontSize: '12px' }} itemStyle={{ color: '#fff' }} />
                            </PieChart>
                        </ResponsiveContainer>
                    </div>
                        ...
                        <div className="h-full bg-slate-900/50 backdrop-blur-sm rounded-xl p-6 flex flex-col justify-between relative z-10">
                            ...
                            <div className="mt-6 bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col md:flex-row items-center gap-6">
                                <div className="flex-1 w-full">
                                    <p className="text-xs text-slate-400 font-bold uppercase mb-2">Sell Candidate</p>
                                ...
                                <div className="flex-1 w-full">
                                    <p className="text-xs text-slate-400 font-bold uppercase mb-2">Execution Order</p>
                                    <div className="flex justify-between items-center bg-black/30 p-3 rounded-lg border border-white/5">
                                        <span className="text-xs text-slate-300">Sell Value:</span>
                                        <span className="font-mono font-bold text-white text-lg">
                                            {harvestAction.isFullExit ? 'FULL EXIT' : formatCurrency(harvestAction.sellValue)}
                                        </span>
                                    </div>
                                </div>
                            </div>
